...
test('SSR properly renders clickable link without errors', () => {
  ...
  expect(string).toBe('<div data-reactroot=""><a href="https://dash.privacygate.io" rel="external" title="Pay with Bitcoin, Bitcoin Cash, DAI, Litecoin, Dogecoin, Ethereum, or USD Coin"><button>Buy With Crypto</button></a></div>');
});
