  ...
  render(){
    ...
    return (
      <div style={wrapperStyle}>
        <a href="https://dash.privacygate.io" rel="external" title="Pay with Bitcoin, Bitcoin Cash, DAI, Litecoin, Dogecoin, Ethereum, or USD Coin" onClick={e => e.preventDefault()}>
